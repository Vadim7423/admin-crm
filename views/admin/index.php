...
<?= GridView::widget([
    ...
    'columns' => [
        ...
        [
                'attribute' => 'Сотрудник',
                'value' => function($data){
                     return !$data->profile->user_id ? '<span class="text-danger">Без фамилии</span>' : '<span class="text-success">'.$data->profile->sername . ' ' . $data->profile->name .'</span>';
                },
               'format' => 'html',
               'filter' => \kartik\select2\Select2::widget([
                    ...
                    'value' => isset($params['sername']) ? $params['sername'] : null,
                    'options' => [
                        'class' => 'form-control',
